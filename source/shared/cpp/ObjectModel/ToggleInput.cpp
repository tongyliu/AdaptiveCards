...
std::shared_ptr<BaseCardElement> ToggleInputParser::Deserialize(const Json::Value& json)
{
...
std::shared_ptr<BaseCardElement> ToggleInputParser::DeserializeFromString(const std::string& jsonString)
{
    return ToggleInputParser::Deserialize(ParseUtil::GetJsonValueFromString(jsonString));
}